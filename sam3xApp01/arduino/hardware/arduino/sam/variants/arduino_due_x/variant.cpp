...
{
//Pio* ; uint32_t       ; uint32_t   ;  EPioType  ;  uint32_t   ;       uint32_t          ;EAnalogChannel; EAnalogChannel  ;EPWMChannel   ;ETCChannel;
//pPort; ulPin          ;ulPeripheralId ;ulPinType;ulPinConfiguration ; ulPinAttribute    ;ulAnalogChannel;ulADCChannelNumber;ulPWMChannel;ulTCChannel;
  ...
  // 13 - AMBER LED (az ExtAnlg3A)
  { PIOB, PIO_PB27B_TIOB0,   ID_PIOB, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER), NO_ADC, NO_ADC, NOT_ON_PWM,  TC0_CHB0     }, // TIOB0

  // 14/15 - USART3 (Serial3) - RS485,1Wire,SDI
  { PIOD, PIO_PD4B_TXD3,     ID_PIOD, PIO_PERIPH_B, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // TXD3
  { PIOD, PIO_PD5B_RXD3,     ID_PIOD, PIO_PERIPH_B, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // RXD3

  // 16/17 - USART1 (Serial2)  Az Radio
  ...
  // 22  Az ExpI1A, PrRadioToRts, PrRadioFmCts ,AnlgMux0
  ...
  // 26 Az AnlgMux1, AnlgMuxA2, AnlgMuxEn-, Rs422OutEn
  ...
  // 30 Az ExtIp4a, PrRadioSt1, Rs422Shdn, LedCpuRed-
  ...
  // 34 Az LedCpuGrn- , Arduino, ExtTwiEn_Unsused,VbstEn
  ...
  // 38 Az Vbst12Ven, Pwr3v3En, NotUsed, WxPwrOn 
  ...
  // 42 Az PwrMtEn, PrRadioToDtr, Pwrin6VaEN,PwrIn30VLdoEN,
  ...
  // 46  Az PwrIn30Vshdn, SdiInEn, SdiOutEn, PrRadionEn
  ...
  // 50 Az RbatTestEn,NotUsed, ExpToProcDout (uart), Notused
  ...
  // 62 Az ThermAdc, RbatAdc, MuxAdc, ExpFmProcDin (uart)
  ...
  // 66 Arduinio, Az ExpIp2a, Rs232InvldSt-, Unused
  ...
  // 86 - SPI CS2 Az ExtToProcDout (Ard Dup #050)
